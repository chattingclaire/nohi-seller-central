  ...
  return (
    <div className={cn("flex flex-col gap-2.5", className)}>
        ...
        {visibleTags.map((tag) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative px-2 py-0.5 rounded-md border text-[11px] font-medium transition-all",
                isSelected
      ...
      <div className="flex items-center gap-1.5">
        <div className="flex-1 flex items-center gap-1.5 rounded-lg border border-border bg-secondary px-2.5 py-1.5 focus-within:ring-2 focus-within:ring-ring transition-all">
        ...
        {moreTags.length > 0 && (
          <Button
            ...
            className="shrink-0 rounded-md h-7 text-[11px] px-2.5"
          >
            Generate
          </Button>
        )}
